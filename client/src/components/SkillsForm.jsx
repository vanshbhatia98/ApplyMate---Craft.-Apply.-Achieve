  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            ...
            />
            <button onClick={addSkill} disabled={!newSill.trim} className='flex items-center gap-2 px-4 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed'>
